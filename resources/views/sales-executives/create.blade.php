...
@section('title', 'Add New Sales Executive')

@section('content')
<div class="d-flex justify-content-between align-items-center mb-4">
    <h2><i class="fas fa-user-graduate me-2"></i>Add New Sales Executive</h2>
...
<div class="row">
    <div class="col-md-8">
        <div class="card">
            ...
            <div class="card-body">
                <form action="{{ route('sales-executives.store') }}" method="POST">
                    @csrf
                    ...
                    <div class="d-flex gap-2">
                        <button type="submit" class="btn btn-primary">
                            <i class="fas fa-save me-2"></i>Create Sales Executive
                        </button>
                        <a href="{{ route('sales-executives.index') }}" class="btn btn-outline-secondary">
