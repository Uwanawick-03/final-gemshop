...
<div class="d-flex justify-content-between align-items-center mb-3">
    <div>
        <h4 class="mb-1"><i class="fas fa-truck me-2"></i>New Supplier</h4>
        <div class="small text-muted">Create a supplier profile</div>
    </div>
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('suppliers.store') }}" class="row g-3">
            ...
            <div class="col-md-3">
                ...
                <input name="supplier_code" value="{{ old('supplier_code') }}" class="form-control @error('supplier_code') is-invalid @enderror">
            ...
            <div class="col-md-4">
                ...
                <input name="contact_person" value="{{ old('contact_person') }}" class="form-control @error('contact_person') is-invalid @enderror">
            ...
            <div class="col-md-4">
                ...
                <select name="payment_terms" class="form-select @error('payment_terms') is-invalid @enderror">
                    @foreach($terms as $t)
                        <option value="{{ $t }}" @selected(old('payment_terms')===$t)>{{ strtoupper(str_replace('_',' ',$t)) }}</option>
                    @endforeach
                </select>
            ...
            <div class="col-md-4">
                ...
                <input name="tax_id" value="{{ old('tax_id') }}" class="form-control @error('tax_id') is-invalid @enderror">
                @error('tax_id')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>

            <div class="col-md-4">
                <label class="form-label">Credit Limit</label>
                <input name="credit_limit" type="number" step="0.01" value="{{ old('credit_limit', 0) }}" class="form-control @error('credit_limit') is-invalid @enderror">
                @error('credit_limit')<div class="invalid-feedback">{{ $message }}</div>@enderror
            </div>
            <div class="col-md-4">
                <label class="form-label">Current Balance</label>
                <input name="current_balance" type="number" step="0.01" value="{{ old('current_balance', 0) }}" class="form-control @error('current_balance') is-invalid @enderror">
