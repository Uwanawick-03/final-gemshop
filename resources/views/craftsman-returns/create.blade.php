    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box">
                ...
                <h4 class="page-title">
                    <i class="fas fa-plus me-2"></i>Create New Craftsman Return
                </h4>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('craftsman-returns.store') }}" method="POST">
                        @csrf
                            ...
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <select class="form-select @error('return_type') is-invalid @enderror" 
                                        ...
                                        <option value="unused_material" {{ old('return_type') == 'unused_material' ? 'selected' : '' }}>Unused Material</option>
                                        <option value="excess" {{ old('return_type') == 'excess' ? 'selected' : '' }}>Excess</option>
                                        <option value="quality_issue" {{ old('return_type') == 'quality_issue' ? 'selected' : '' }}>Quality Issue</option>
                                    </select>
                                    @error('return_type')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('reason') is-invalid @enderror" 
                                      ...
                                      placeholder="Describe the reason for this return..." required>{{ old('reason') }}</textarea>
                            @error('reason')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3">
                            ...
                            <textarea class="form-control @error('notes') is-invalid @enderror" 
                                      ...
                                      placeholder="Add any additional notes about this return...">{{ old('notes') }}</textarea>
                            @error('notes')
                            <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex justify-content-end gap-2">
                                    <a href="{{ route('craftsman-returns.index') }}" class="btn btn-secondary">
